...
class RayPPOTrainer:
    ...
    def __init__(
        ...
        if self.hybrid_engine:
            # NOTE: kx remove assertion
            print(role_worker_mapping.keys())
    ...
    def init_workers(self):
        ...
        if self.hybrid_engine:
            ...
            actor_rollout_cls = RayClassWithInitArgs(
                ...
                # role="actor_rollout", # NOTE: kx ActorRollout -> ActorRolloutRef
                role="actor_rollout_ref" if self.config.algorithm.mix_rollout.enable else "actor_rollout",
