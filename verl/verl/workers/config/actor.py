...
class ActorConfig(BaseConfig):
    ...
    mix_probs: bool = False
    mix_probs_main_ratio: float = 0.5
    mix_probs_on_ref_only: bool = False
    mix_probs_w_const: bool = False
    mix_probs_w_old: bool = False
    replace_old_probs: bool = False
    replace_on_ref_only: bool = True
    replace_on_adv: bool = False
    replace_method: str = "ref" # ref, mix, max, avg
    renorm_adv: str = "none"  # none, token, seq, batch
